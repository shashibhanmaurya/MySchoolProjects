...
namespace MySchoolSolution
{
    public partial class YearlyFeeEntry : Form
    {
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        CommonFunctions.ShowError("Student has alredy Deposited the fee, it cannot be change now! ");
                    }
                }
        ...
        private bool ValidateFeeDeposit()
        {
            bool b = false;
            if (txtAdmissionNo.Text != "" && txtAdmissionNo.Text != "0")
            {
                ...
                DataSet ds = SqlHelper.ExecuteDataset(Connection.Connection_string, "SelectMonthlyFeeForStudent", m);
                if (ds.Tables[0].Rows.Count > 0)
                    b = true;
                else
                    b = false;
