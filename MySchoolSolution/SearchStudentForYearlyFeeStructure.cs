...
{
    public partial class SearchStudentForYearlyFeeStructure : Form
    {
        public SearchStudentForYearlyFeeStructure()
        {
            InitializeComponent();
        }

        private void SearchStudentForYearlyFeeStructure_Load(object sender, EventArgs e)
        {
